...
Upon checking, the rating distribution of the new data is similar to the original one, with the majority of reviews are at extreme positions, either 1 or 5 stars (@fig-eda-rating-new).
...
![Distribution of BERT predicted star ratings and sentiment scores — older dataset](plots/bert_old_distribution.png){#fig-bert-dist-old width=90% fig-pos="H"}

![Distribution of BERT predicted star ratings and sentiment scores — newer dataset](plots/bert_new_distribution.png){#fig-bert-dist-new width=90% fig-pos="H"}
...
![BERT sentiment score by star rating — older dataset](plots/bert_old_sentiment_score_boxplot.png){#fig-bert-box-old width=90% fig-pos="H"}

![BERT sentiment score by star rating — newer dataset](plots/bert_new_sentiment_score_boxplot.png){#fig-bert-box-new width=90% fig-pos="H"}
...
![Average BERT sentiment score by bank and platform — older dataset](plots/bert_old_banknplatform.png){#fig-bert-bank-old width=90% fig-pos="H"}

![Average BERT sentiment score by bank and platform — newer dataset](plots/bert_new_banknplatform.png){#fig-bert-bank-new width=90% fig-pos="H"}
...
![BERT sentiment score by star rating per platform — older dataset](plots/bert_old_per_platform.png){#fig-bert-plat-old width=90% fig-pos="H"}

![BERT sentiment score by star rating per platform — newer dataset](plots/bert_new_per_platform.png){#fig-bert-plat-new width=90% fig-pos="H"}
...
![Average AFINN sentiment score by bank and platform — newer dataset](plots/AFINN_new_sentiment_barchart.png){#fig-afinn-sent-bank-new width=90% fig-pos="H"}
