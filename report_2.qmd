...
- **Asymmetric preprocessing:** the old pipeline includes lemmatisation while the new does not; bigram construction exists in the new pipeline but not the old, making cross-dataset lexicon comparisons not strictly like-for-like.
...
- **Platform label inconsistency:** the old dataset's rating distribution plot was generated before platform mapping, producing four panels instead of two and reflecting a preprocessing artefact rather than a genuine structural difference from the new data.
