...
![Distribution of Bing Sentiment Words in R](plots/r_bing_distribution.png){#fig-r-bing-distribution width=90%}

![Distribution of Bing Sentiment Words in Python](plots/old_lexicon_bing_distribution.png){#fig-lexicon-old-bing-distribution width=90%}
...
![Distribution of Review-Level Bing Sentiment Scores in R](plots/r_bing_review_lvl_sentiment.png){#fig-r-bing-review-lvl width=90%}

![Distribution of Review-Level Bing Sentiment Scores in Python](plots/old_lexicon_bing_review_lvl_sentiment.png){#fig-lexicon-old-bing-review-lvl width=90%}
...
![Review-Level Bing Sentiment Score by Star Rating in R](plots/r_bing_review_sentiment_by_star.png){#fig-r-bing-review-sentiment-star width=90%}

![Review-Level Bing Sentiment Score by Star Rating in Python](plots/old_lexicon_bing_sentiment_by_star.png){#fig-lexicon-old-bing-sentiment-star width=90%}
...
![Average AFINN Sentiment by Bank and Platform in R](plots/r_afinn_avg_sentiment_bank_platform.png){#fig-r-afinn_avg_sentiment width=90%}

![Average AFINN Sentiment by Bank and Platform in Python](plots/old_lexicon_afinn_avg_sentiment_bank_platform.png){#fig-lexicon-old-afinn_avg_sentiment width=90%}
...
![Distribution of NRC Emotion Categories in R](plots/r_nrc_emotion_distriution.png){#fig-r-nrc_emotion width=90%}

![Distribution of NRC Emotion Categories in Python](plots/old_lexicon_nrc_emotion_distribution.png){#fig-lexicon-old-nrc_emotion width=90%}
...
![Top 20 Most Frequent Bigrams in R](plots/r_bigrams_top_20.png){#fig-r-bigrams width=90%}

![Top 20 Most Frequent Bigrams in Python](plots/old_lexicon_bigrams_top_20.png){#fig-lexicon-old-bigrams width=90%}
...
![Average Negation-Induced Sentiment Correction by Star Rating in R](plots/r_average_negation_sentiment.png){#fig-r-negation width=90%}

![Average Negation-Induced Sentiment Correction by Star Rating in Python](plots/old_lexicon_average_negation_sentiment.png){#fig-lexicon-old-negation width=90%}
...
![Comparison of Unigram and Bigram Sentiment Scores with Negation Handling in R](plots/r_overall_sentiment.png){#fig-r-overall width=90%}

![Comparison of Unigram and Bigram Sentiment Scores with Negation Handling in Python](plots/old_lexicon_overall_sentiment.png){#fig-lexicon-overall width=90%}
